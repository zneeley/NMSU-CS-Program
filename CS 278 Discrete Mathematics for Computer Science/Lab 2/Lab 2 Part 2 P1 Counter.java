 ...
 * Description: This program will the ((∀x p(x)) → (∀x q(x))) → ∀x (p(x) → q(x)) and make it false.
*/

public class Lab2Part2Eq1Counter {
    ...
    public static void main(String[] args) {
        System.out.println("The counter to the problem is: " + W());
    }
