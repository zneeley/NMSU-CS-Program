...
;   Date: 4/12/2018
;   Class: CS 370
;   Assignment: Lab 8 combine and understand the NSM code to read in a number and calculate the sum of squares
;

section .data

_L0:	db "Enter a number: ", 0		;global string
_L4:	db "The sum of squares of", 0		;global string
_L5:	db "is", 0		;global string
section .text
 	global main
...
; get number
	...
	mov rsi, [rax]           ; store the number in rsi
