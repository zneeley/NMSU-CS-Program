...
/**
 * Method toString() converts the data array into a string
 ...
 */
  public String toString() {
    ...
    // Add the data from the data array to the string
    for (int i = t; i >= 0; i--) {
...
/**
 * Clone method will clone the current stack and returning a new stack with the same objects 
 * @return ArrayStack<E>
 */
public ArrayStack<E> clone() {
        ArrayStack<E> myStack = new ArrayStack<E>(t);
        
        myStack.data = Arrays.copyOf(data, data.length);
