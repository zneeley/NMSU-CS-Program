...
public class SinglyLinkedList<E> implements Cloneable {
  ...
  public String toString() {
    ...
    // Empty string for the return
    String isEmptyList = "empty list";
    
    // Node to loop through the list
    Node<E> walk = head;
    ...
    if (this.isEmpty()) {
      return isEmptyList;
        ...
        // Add the next element to the string builder
        sb.append(walk.getElement());
        
        // If walk is not at the tail add a new line
        if (walk != tail)
            sb.append("\n");
   ...
   * Method remove
   * @author Zach Neeley
   * @param e The element needed to be removed
   * @return newList SinglyLinkedList
   */
  public Node<E> remove( E e ) {
      
      // Create node to loop though the list
      Node<E> walk = head;
      
      // Create a newList to store the values
      SinglyLinkedList<E> newList = new SinglyLinkedList<E>();
      
      // Boolean to see if the value was found
      boolean found = false;
      
      // Loop though the SinglyLinkedList 
      while (walk != null) {
         
          // If the element of SinglyLinkedList matched e and a value has not been found
          if (walk.getElement() == e && found == false) {
              
              // Set found to true and decrement size
              found = true;
              size--;
