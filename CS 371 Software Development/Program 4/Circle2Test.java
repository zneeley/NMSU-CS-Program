...
public void setup()
{
   ...
   //new circle for intersects tests 
   circle2New = new Circle2(2,4,6);
}
...
//
// Test intersects for the new circle 
//
@Test
public void simpleIntersects()
{
   Assert.assertTrue(circle2.intersects(circle2New));
}
